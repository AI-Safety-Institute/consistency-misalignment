"""Tests for PairedDataCollator and tokenize_paired_dataset."""
...
class TestTokenizePairedDataset:
    ...
    def test_truncates_to_max_length(self) -> None:
        ...
        tokenized = tokenize_paired_dataset(paired, _CharTokenizer(), max_length=3)
